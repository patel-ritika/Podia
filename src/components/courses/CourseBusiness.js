...
import "../../asset/styles/courses/coursebusiness.css";
...
const CourseBusiness = () => {
  return (
    <div className="course-business-container">
    <h1>
    Real online courses built by enterpreneurs like you
    </h1>
    <h4>
    ...
    <div className="creator-container">
      <div className="creator_box">
        <img src={image1} alt="creator_Box 1" />
      ...
      <div className="creator_box">
        <img src={image2} alt="creator_Box 2" />
      ...
      <div className="creator_box">
        <img src={image3} alt="creator_Box 3" />
      ...
      <div className="creator_box">
        <img src={image4} alt="creator_Box 4" />
