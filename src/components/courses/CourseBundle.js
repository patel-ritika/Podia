...
import "../../asset/styles/courses/coursebundle.css";

const CourseBundle = () => {
  return (
    <div className="coursegrow-container">
    {/* Left Side */}
    <div className="coursegrow-left">
      <h1>
    ...
    {/* Right Side */}
    <div className="coursegrow-right">
      <div className="coursegrow-item">
