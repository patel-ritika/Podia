...
const CourseBuild = () => {
  return (
    ...
    <div className="row">
      ...
      <h5><span className="icon"><FaCheck /></span>Ultimate flexibility </h5>
      ...
      <div className="column">
        <h5><span className="icon"><FaCheck /></span>Your course, your way </h5>
        <p>Build a self-paced course, a cohort-based course,<br></br>
         or a course where content is delivered on a<br></br>
          schedule.</p>
      </div>
      <div className="column">
        <h5><span className="icon"><FaCheck /></span>Build stress-free </h5>
